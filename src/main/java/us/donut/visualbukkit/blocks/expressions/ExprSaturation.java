...
@Category("Player")
@Description({"The saturation level of a player", "Changers: set, add, remove", "Returns: number"})
public class ExprSaturation extends ChangeableExpressionBlock<Float> {
