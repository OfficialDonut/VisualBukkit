...
public class StatContinueLoop extends Statement {
    ...
    public Block createBlock() {
        return new Block(this) {
            ...
            public void update() {
                super.update();
                setValid(checkForContainer(StatListLoop.class) || checkForContainer(StatNumberLoop.class) || checkForContainer(StatAdvancedNumberLoop.class) || checkForContainer(StatWhileLoop.class));
            }
