...
public class StatSetComplexVariable extends Statement {
    ...
    public Block createBlock() {
        return new Block(this, new ChoiceParameter("global", "persistent"), new StringLiteralParameter(), new ExpressionParameter(ClassInfo.LIST), new ExpressionParameter(ClassInfo.OBJECT)) {
            @Override
