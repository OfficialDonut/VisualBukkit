...
public class MethodExpression extends Expression {
    ...
    private static SetMultimap<String, MethodExpression> methodExpressions = TreeMultimap.create(Comparator.naturalOrder(), (o1, o2) -> Comparator.nullsFirst((Comparator<ClassInfo[]>) (a1, a2) -> {
