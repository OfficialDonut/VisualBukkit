...
public class StatSubtractFromSimpleGlobalVariable extends Statement {

    public StatSubtractFromSimpleGlobalVariable() {
        super("stat-subtract-from-simple-global-variable");
    }
